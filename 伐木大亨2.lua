...
local Cloudlib = loadstring(game:HttpGet("https://raw.githubusercontent.com/XiaoYunCN/Kavo-Ui/main/%E4%BC%90%E6%9C%A8%E5%A4%A7%E4%BA%A82.lua", true))()
local window = Coludlib:new("白--伐木大亨2", '')
...
Section:Button("获取当前死亡后加载时间", function()
    Cloudlib:Notification("白", " 时间为" .. Cloud.loaddupeaxewaittime .. "秒", "好")
end)
